...
import { AuthenticatedUserButtons, GuestButton } from "./UserButtons/index";
import NavHeader from "./NavHeader";
import { Toaster, Position, Intent } from "@blueprintjs/core";

import { authenticatedCall, noAuthCall } from "../auth-client";
...
class Home extends Component {
  ...
  handleAuthentication = () => {
    if (this.state.authenticated) {
      ...
      return <GuestButton signIn={this.props.authStore.signIn} />;
    }
  };
